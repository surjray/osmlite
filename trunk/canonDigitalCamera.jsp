...
<title>CANON Digital Camera: OSMlite</title>
<link rel="stylesheet" href="sb_Styles-V1.1.css" type="text/css"/>

<script language="javascript">
function startInit()
{
  document.canonDigiCam.searchText.select();
  document.canonDigiCam.searchText.focus();
  document.canonDigiCam.search_button.disabled = true;
}
...
function myMethod(v)
{
  document.canonDigiCam.modelID1.value = v;
  document.canonDigiCam.action = "http://localhost:8080/OSM/Product_DigitalCamera.jsp";
  document.canonDigiCam.submit();
}

function forward(temp1,temp2,p)
{
  document.canonDigiCam.modelID2.value = temp1;
  document.canonDigiCam.forwarding.value = temp2;
  document.canonDigiCam.price.value = p;
  document.canonDigiCam.action = "http://localhost:8080/OSM/Forward.jsp";
  document.canonDigiCam.submit();
}
function forwardTo(v) //--------------this function is newly added on 14th feb, add it.------------
{
  document.canonDigiCam.forwarding.value = "empty";//-----Set value of "forwarding" to "empty"---- 
  document.canonDigiCam.count.value = v;//-------also add a "count" hidden field----------------
  document.canonDigiCam.action = "http://localhost:8080/OSM/ShoppingCart.jsp";
  document.canonDigiCam.submit();
}
function cart(temp1,p,c,v,m,temp2)
{
  ...
  document.canonDigiCam.forwarding.value = temp2;
  document.canonDigiCam.price.value = p;
  document.canonDigiCam.catgry.value = c;
  document.canonDigiCam.vendor.value = v;
  document.canonDigiCam.model.value = m;
  document.canonDigiCam.quantity.value = 1; //default
  document.canonDigiCam.action="http://localhost:8080/OSM/Forward.jsp";
  document.canonDigiCam.submit();
}
</script>
...
<form name="canonDigiCam" method="get">
<%
...
<input type="hidden" name="pageID" value="DigiCam_Canon">
...
<h2>~ <u>CANON Digital Cameras</u> ~</h2>
</font>
</caption>
<tr>
<td align="center" rowspan="3">
<a href="#" onclick='myMethod("digicamCanonixus80")'><img  border="2" src="images/digital_camera/canon/Canon_ixus80_s.jpg" height="150" width="140"></a>
</td>
...
<td rowspan="11">&nbsp;</td>
<td align="center" rowspan="3">
<a href="#" onclick='myMethod("digicamCanonixus85")'><img  border="2" src="images/digital_camera/canon/Canon_ixus85_s.jpg" height="150" width="140"></a>
</td>
<td align="left"><h3>Vendor: </h3></td>
<td align="center"><font color="#000000" face="Times New Roman, Times, serif">
<h4>CANON</h4></font>
...
<td align="center"><font color="#000000" face="Times New Roman, Times, serif">
<h4>CANON: ixus80</h4></font>
</td>
<td align="left"><h3> Model: </h3></td>
<td align="center"><font color="#000000" face="Times New Roman, Times, serif">
<h4>CANON: ixus85</h4></font>
</td>
</tr>
<tr>
...
<td align="center">
<input type="button" name="atc" value="Add to Cart" onclick='cart("digicamCanonixus80","6490","Digital Camera","CANON","CANON: ixus80","ShoppingCart.jsp")'>
<!--
<font color="#000000" face="Tahoma" size="2">
Or,</font>
-->
</td>
<td align="center"><input type="button" value="Buy Now" name="b1" onclick='forward("digicamCanonixus80","Buy.jsp","6490")'></td>
<td align="center"><font color="#000000" face="Times New Roman, Times, serif">
<b><u>Click for features</u></b></font>
</td>
<td align="center">
<input type="button" name="atc" value="Add to Cart" onclick='cart("digicamCanonixus85","9990","Digital Camera","CANON","CANON: ixus85","ShoppingCart.jsp")'>
</td>
<td align="center"><input type="button" value="Buy Now" name="b2" onclick='forward("digicamCanonixus85","Buy.jsp","9990")'></td>
</tr>
<tr>
<td colspan="8">&nbsp;</td>
</tr>
...
<tr>
<td align="center" rowspan="3">
<a href="#" onclick='myMethod("digicamCanonixus970")'><img  border="2" src="images/digital_camera/canon/Canon_ixus970_s.jpg" height="150" width="140"></a>
</td>
<td align="left"><h3>Vendor :</h3></td>
<td align="center"><font color="#000000" face="Times New Roman, Times, serif">
<h4>CANON</h4></font>
...
<td align="center" rowspan="3">
<a href="#" onclick='myMethod("digicamCanonixus980")'><img  border="2" src="images/digital_camera/canon/Canon_ixus980_s.jpg" height="150" width="140"></a>
</td>
<td align="left"><h3>Vendor :</h3></td>
<td align="center"><font color="#000000" face="Times New Roman, Times, serif">
<h4>CANON</h4></font>
...
<td align="left"><h3> Model: </h3></td>
<td align="center"><font color="#000000" face="Times New Roman, Times, serif">
<h4>CANON: ixus970</h4></font>
</td>
<td align="left"><h3> Model: </h3></td>
<td align="center"><font color="#000000" face="Times New Roman, Times, serif">
<h4>CANON: ixus980</h4></font>
</td>
</tr>
<tr>
<td align="left"><h3> Price: </h3></td>
...
<td align="center">
<input type="button" name="atc" value="Add to Cart" onclick='cart("digicamCanonixus970","11990","Digital Camera","CANON","CANON: ixus970","ShoppingCart.jsp")'>
</td>
<td align="center"><input type="button" value="Buy Now" name="b3" onclick='forward("digicamCanonixus970","Buy.jsp","11990")'></td>
<td align="center"><font color="#000000" face="Times New Roman, Times, serif">
<b><u>Click for features</u></b></font>
</td>
<td align="center">
<input type="button" name="atc" value="Add to Cart" onclick='cart("digicamCanonixus980","13990","Digital Camera","CANON","CANON: ixus980","ShoppingCart.jsp")'>
</td>
<td align="center"><input type="button" value="Buy Now" name="b4" onclick='forward("digicamCanonixus980","Buy.jsp","13990")'></td>
</tr>
<tr>
<td colspan="8">&nbsp;</td>
</tr>
