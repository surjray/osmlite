...
String sql = "UPDATE user SET password= '"+ newPassword + "' WHERE userid= '"+ uid1 +"'";
...
<h1>Welcome!&nbsp;<%= uid %></h1>
<h2>Your password has been successfully changed. Please Login again with your new pasword.</h2>
