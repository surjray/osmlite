...
<input name="searchButton" type="button" value="Search" onclick="forwardToSearch(this.form)" />
   ...
   <%
    ...
    ResultSet rs=null;
    String qr="select * from books where id=?";
...
double save=(prc*100)/(100-disc)-prc;
	%>	      
      <tr>
	  <td><img src="<%= img %>" alt="Cover page"/></td>
	  <td>
	<ul>
		<li style="white-space: nowrap"><strong><%= name %></strong></li>
		<li>Author: <%= auth %></li>
		<li>Format: <%= frm %></li>
		<li>Publisher: <%= pub %></li>
		<li>ISBN: <%= isbn %></li>
...
<div id="footer">
<input type="button" value="Back" onclick='window.location.assign("sb_Books.jsp");'/>
</div>
