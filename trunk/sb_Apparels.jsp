...
<title>Apparels catalog</title>
  ...
  <body onload="init()">
	  <form action="sb_Apparels.jsp" method="post">
<div id="header"></div>
<div id="tabs">
  <ul>
...
<input name="searchButton" type="button" value="Search" onclick="forwardToSearch(this.form)" />
    ...
    Statement st=null;
    ResultSet rs=null;
    int fr1=1,to1=8,MAX=15,fr2=fr1,to2=to1;//default
    ...
    String qr="select * from apparels order by"+srt;
...
double prc=rs.getDouble("price");
    %>
      <tr>
	  <td><%= row %></td>
	  <td><a href="sb_Apparel.jsp?id=<%= id %>"><img src="<%= img %>" alt="Product Sample"/></a></td>
	  <td>
		<ul>
