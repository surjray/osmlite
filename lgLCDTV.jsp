...
<title>LG LCD TeleVision: OSMlite</title>
...
function startInit()
{
  document.lgLCD.searchText.select();
  document.lgLCD.searchText.focus();
  document.lgLCD.search_button.disabled = true;
}
...
function myMethod(v)
{
  document.lgLCD.modelID1.value = v;
  document.lgLCD.action = "http://localhost:8080/OSM/Product_LCD.jsp";
  document.lgLCD.submit();
}

function forward(temp1,temp2,p)
{
  document.lgLCD.modelID2.value = temp1;
  document.lgLCD.forwarding.value = temp2;
  document.lgLCD.price.value = p;
  document.lgLCD.action = "http://localhost:8080/OSM/Forward.jsp";
  document.lgLCD.submit();
}
function forwardTo(v)
{
  document.lgLCD.forwarding.value = "empty"; 
  document.lgLCD.count.value = v;
  document.lgLCD.action = "http://localhost:8080/OSM/ShoppingCart.jsp";
  document.lgLCD.submit();
}
function cart(temp1,p,c,v,m,temp2)
{
  ...
  document.lgLCD.forwarding.value = temp2;
  document.lgLCD.price.value = p;
  document.lgLCD.catgry.value = c;
  document.lgLCD.vendor.value = v;
  document.lgLCD.model.value = m;
  document.lgLCD.quantity.value = 1; //default
  document.lgLCD.action="http://localhost:8080/OSM/Forward.jsp";
  document.lgLCD.submit();
}
</script>
...
<form name="lgLCD" action="" method="get">
<%
...
<input type="hidden" name="pageID" value="LCD_LG">
...
-->
<table border="0" align="center" cellspacing="5" cellpadding="5" bgcolor="#FFFFCC" width="80%">
<caption align="top"><font color="#FF6666" face="Tahoma" size="4">
<h2>~ <u>LG LCD TeleVision</u> ~</h2>
</font>
</caption>
<!--<tr>
<td colspan="4"><hr></td>
...
<tr>
<td rowspan="3" align="center"><a href="#" onclick='myMethod("LCDLg47LG53FR")'><img  border="2" src="images/LCD_TV/LG/LG94,490_s1.gif" height="200" width="200"></a></td>
<td><h2>Vendor :</h2></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
<h3>LG</h3></font>
</td>
<td align="center">
<input type="button" name="atc" value="Add to Cart" onclick='cart("LCDLg47LG53FR","94490","LCD","LG","LG: LCD 47LG53FR","ShoppingCart.jsp")'>
&nbsp;
...
<td><h2>Model: </h2></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
<h3>LG: LCD 47LG53FR</h3></font>
</td>
<td><input type="button" value="Buy Now" name="b1" onclick='forward("LCDLg47LG53FR","Buy.jsp","94490")'></td>
</tr>
<tr>
<td><h2>Price: </h2></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
<h3>Rs.94,490</h3></font>
</td>
<td>&nbsp;</td>
</tr>
<tr>
...
<tr>
<td rowspan="3" align="center"><a href="#" onclick='myMethod("LCDLg22LG30R")'><img border="2" src="images/LCD_TV/LG/LG18,000_s2.gif" height="200" width="200"></a></td>
<td><h2>Vendor :</h2></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
<h3>LG</h3></font>
</td>
<td align="center">
<input type="button" name="atc" value="Add to Cart" onclick='cart("LCDLg22LG30R","18000","LCD TV","LG","LG: LCD 22LG30R","ShoppingCart.jsp")'>
&nbsp;
<font color="#000000" face="Tahoma" size="2">
Or,</font>
</td>
...
<td><h2>Model: </h2></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
<h3>LG: LCD 22LG30R</h3></font>
</td>
<td><input type="button" value="Buy Now" name="b2" onclick='forward("LCDLg22LG30R","Buy.jsp","18000")'></td>
</tr>
<tr>
<td><h2>Price: </h2></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
<h3>Rs.18,000</h3></font>
</td>
<td>&nbsp;</td>
</tr>
<tr>
...
<tr>
<td rowspan="3" align="center"><a href="#" onclick='myMethod("LCDLg42LG80FR")'><img border="2" src="images/LCD_TV/LG/LG83,000_s3.jpg" height="200" width="200"></a></td>
<td><h2>Vendor :</h2></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
<h3>LG</h3></font>
</td>
<td align="center">
<input type="button" name="atc" value="Add to Cart" onclick='cart("LCDLg42LG80FR","83000","LCD TV","LG","LG: LCD 42LG80FR","ShoppingCart.jsp")'>
&nbsp;
<font color="#000000" face="Tahoma" size="2">
Or,</font>
</td>
...
<td><h2>Model: </h2></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
<h3>LG: LCD 42LG80FR</h3></font>
</td>
<td><input type="button" value="Buy Now" name="b3" onclick='forward("LCDLg42LG80FR","Buy.jsp","83000")'></td>
</tr>
<tr>
<td><h2>Price: </h2></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
<h3>Rs.83,000</h3></font>
</td>
<td>&nbsp;</td>
</tr>
<tr>
...
<tr>
<td rowspan="3" align="center"><a href="#" onclick='myMethod("LCDLg42LG70YR")'><img border="2" src="images/LCD_TV/LG/LG1,50,000_s4.jpg" height="200" width="200"></a></td>
<td><h2>Vendor :</h2></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
<h3>LG</h3></font>
</td>
<td align="center">
<input type="button" name="atc" value="Add to Cart" onclick='cart("LCDLg42LG70YR","150000","LCD TV","LG","LG: LCD 42LG70YR","ShoppingCart.jsp")'>
&nbsp;
<font color="#000000" face="Tahoma" size="2">
Or,</font>
</td>
...
<td><h2>Model: </h2></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
<h3>LG: LCD 42LG70YR </h3></font>
</td>
<td><input type="button" value="Buy Now" name="b4" onclick='forward("LCDLg42LG70YR","Buy.jsp","150000")'></td>
</tr>
<tr>
<td><h2>Price: </h2></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
<h3>Rs.1,50,000</h3></font>
</td>
<td>&nbsp;</td>
</tr>
<tr>
