...
<title>Nokia Mobiles: OSMlite</title>
...
function startInit()
{
  document.nokiaMobiles.searchText.select();
  document.nokiaMobiles.searchText.focus();
  document.nokiaMobiles.search_button.disabled = true;
}
...
function myMethod(v)
{
  document.nokiaMobiles.modelID1.value = v;
  document.nokiaMobiles.action = "http://localhost:8080/OSM/product_mobile.jsp";
  document.nokiaMobiles.submit();
}

function forward(temp1,temp2,p)
{
  document.nokiaMobiles.modelID2.value = temp1;
  document.nokiaMobiles.forwarding.value = temp2;
  document.nokiaMobiles.price.value = p;
  document.nokiaMobiles.action = "http://localhost:8080/OSM/Forward.jsp";
  document.nokiaMobiles.submit();
}
function forwardTo(v)
{
  document.nokiaMobiles.forwarding.value = "empty"; 
  document.nokiaMobiles.count.value = v;
  document.nokiaMobiles.action = "http://localhost:8080/OSM/ShoppingCart.jsp";
  document.nokiaMobiles.submit();
}
function cart(temp1,p,c,v,m,temp2)
{
  ...
  document.nokiaMobiles.forwarding.value = temp2;
  document.nokiaMobiles.price.value = p;
  document.nokiaMobiles.catgry.value = c;
  document.nokiaMobiles.vendor.value = v;
  document.nokiaMobiles.model.value = m;
  document.nokiaMobiles.quantity.value = 1; //default
  document.nokiaMobiles.action="http://localhost:8080/OSM/Forward.jsp";
  document.nokiaMobiles.submit();
}
</script>
...
<form name="nokiaMobiles" action="" method="get">
<%
...
<input type="hidden" name="pageID" value="Mob_Nokia">
...
-->
<table border="0" align="center" cellspacing="5" cellpadding="5" bgcolor="#FFFFCC" width="90%">
<caption align="top"><font color="#FF6666" face="Tahoma">
<h2>~ <u>NOKIA Mobiles</u> ~</h2>
</font>
</caption>
<!--<tr>
<td colspan="4"><hr></td>
...
<tr>
<td rowspan="3" align="center"><a href="#" onclick='myMethod("mobN5220")'><img  border="2" src="images/mobiles/nokia/nokia_5220_s.jpg" height="100" width="100"></a></td>
<td><b>Vendor :</b></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
Nokia</font>
</td>
<td align="center">
<input type="button" name="atc" value="Add to Cart" onclick='cart("mobN5220","7700","Mobile","Nokia","Nokia: 5220","ShoppingCart.jsp")'>
&nbsp;
...
<td align="left"><input type="button" value="Buy Now" name="b1" onclick='forward("mobN5220","Buy.jsp","7700")'></td>
</tr>
<tr>
<td><b>Price: </b></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
...
<tr>
<td rowspan="3" align="center"><a href="#" onclick='myMethod("mobN5800a")'><img border="2" src="images/mobiles/nokia/Nokia_5800a_s.jpg" height="100" width="100"></a></td>
<td><b>Vendor :</b></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
Nokia</font>
</td>
<td align="center">
<input type="button" name="atc" value="Add to Cart" onclick='cart("mobN5800a","18500","Mobile","Nokia","Nokia: 5800a","ShoppingCart.jsp")'>
&nbsp;
<font color="#000000" face="Tahoma" size="2">
Or,</font>
</td>
...
<td align="left"><input type="button" value="Buy Now" name="b2" onclick='forward("mobN5800a","Buy.jsp","18500")'></td>
</tr>
<tr>
<td><b>Price: </b></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
...
<tr>
<td rowspan="3" align="center"><a href="#" onclick='myMethod("mobNN81")'><img border="2" src="images/mobiles/nokia/Nokia_N81_s.jpg" height="100" width="100"></a></td>
<td><b>Vendor :</b></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
Nokia</font>
</td>
<td align="center">
<input type="button" name="atc" value="Add to Cart" onclick='cart("mobNN81","9950","Mobile","Nokia","Nokia: N81","ShoppingCart.jsp")'>
&nbsp;
<font color="#000000" face="Tahoma" size="2">
Or,</font>
</td>
...
<td align="left"><input type="button" value="Buy Now" name="b3" onclick='forward("mobNN81","Buy.jsp","9950")'></td>
</tr>
<tr>
<td><b>Price: </b></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
...
<tr>
<td rowspan="3" align="center"><a href="#" onclick='myMethod("mobN3500C")'><img border="2" src="images/mobiles/nokia/Nokia_3500C_s.jpg" height="100" width="100"></a></td>
<td><b>Vendor :</b></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
Nokia</font>
</td>
<td align="center">
<input type="button" name="atc" value="Add to Cart" onclick='cart("mobN3500C","4500","Mobile","Nokia","Nokia: 3500 Classic","ShoppingCart.jsp")'>
&nbsp;
<font color="#000000" face="Tahoma" size="2">
Or,</font>
</td>
...
<td><b>Model: </b></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
Nokia: 3500 Classic</font>
</td>
<td align="left"><input type="button" value="Buy Now" name="b4" onclick='forward("mobN3500C","Buy.jsp","4500")'></td>
</tr>
<tr>
<td><b>Price: </b></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
...
<tr>
<td rowspan="3" align="center"><a href="#" onclick='myMethod("mobN3120C")'><img border="2" src="images/mobiles/nokia/nokia_3120classic_s.jpg" height="100" width="100"></a></td>
<td><b>Vendor :</b></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
Nokia</font>
</td>
<td align="center">
<input type="button" name="atc" value="Add to Cart" onclick='cart("mobN3120C","4100","Mobile","Nokia","Nokia: 3120 Classic","ShoppingCart.jsp")'>
&nbsp;
<font color="#000000" face="Tahoma" size="2">
Or,</font>
</td>
...
<td><b>Model: </b></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
Nokia: 3120 Classic</font>
</td>
<td align="left"><input type="button" value="Buy Now" name="b5" onclick='forward("mobN3120C","Buy.jsp","4100")'></td>
</tr>
<tr>
<td><b>Price: </b></td>
<td><font color="#000000" face="Times New Roman, Times, serif">
